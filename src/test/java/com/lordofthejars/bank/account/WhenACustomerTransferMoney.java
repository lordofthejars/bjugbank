...
public class WhenACustomerTransferMoney {
    ...
    public static JavaArchive createDeployment() {
        JavaArchive javaArchive = ShrinkWrap.create(JavaArchive.class).addPackage(BankEntityManager.class.getPackage())
                .addPackage(PersistenceHandler.class.getPackage()).addClass(Account.class).addClass(Customer.class)
                .addClass(AccountService.class).addClass(JpaAccountRepository.class)
                .addClass(JpaCustomerRepository.class).addClass(DbPopulator.class)
        ...
        return Descriptors
                .create(PersistenceDescriptor.class)
                    .createPersistenceUnit()
                        ...
                        .clazz("com.lordofthejars.bank.account.entity.Account",
                                "com.lordofthejars.bank.customer.entity.Customer").up();
    }
